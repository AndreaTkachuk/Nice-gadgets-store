...
const en: Dictionary = {
  ...
  'sort.exp': 'Expensive',
  'sort.cheap': 'Cheapest',
  'favorite.title': 'Favourites',
  'favorite.no-items': 'There are no products matching the query',
...
const it: Dictionary = {
  ...
  'favorite.no-items': 'Non ci sono prodotti che corrispondono alla query',
